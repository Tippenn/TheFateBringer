...
public class PossibleDropVisual : MonoBehaviour
{
    [Serializable]
    public struct TilemapSpriteUV
    {
        public TileMap.TilemapObject.Deployability deployableSprite;
    ...
    private Dictionary<TileMap.TilemapObject.Deployability, UVCoords> uvCoordsDictionary;
    ...
    private void Awake()
    {
        ...
        uvCoordsDictionary = new Dictionary<TileMap.TilemapObject.Deployability, UVCoords>();
    ...
    private void UpdateHeatMapVisual()
    {
        ...
        for (int x = 0; x < grid.GetWidth(); x++)
        {
            for (int y = 0; y < grid.GetHeight(); y++)
            {
                ...
                TileMap.TilemapObject.Deployability deployability = gridObject.GetDeployability();

                Vector2 gridUV00, gridUV11;
                //Debug.Log(deployability);
                if (deployability == TileMap.TilemapObject.Deployability.Deployable || showMesh == false)
                {
                ...
                {
                    UVCoords uVCoords = uvCoordsDictionary[deployability];
        ...
        SetTransparency(meshRenderer,0.6f);
        //GetComponent<MeshFilter>().mesh = mesh;
